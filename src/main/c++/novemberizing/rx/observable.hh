...
public:  inline virtual void emit(const T & o) final;
public:  inline virtual void emit(const T && o) final;
protected:  inline virtual void error(const Throwable & e) final;
protected:  inline virtual void complete(void) final;
public:     inline virtual Subscription<T> * subscribe(Observer<T> * observer) final;
